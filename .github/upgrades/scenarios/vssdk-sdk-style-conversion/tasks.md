...
- ✅ 01-unload-projects: Unload VSIX projects in Visual Studio ([Content](tasks/01-unload-projects/task.md), [Progress](tasks/01-unload-projects/progress-details.md))
...
- 🔄 02-convert-main-vsix-project: Convert VisualStudio.Templates.csproj to SDK-style with VSSDK overlay ([Content](tasks/02-convert-main-vsix-project/task.md))
